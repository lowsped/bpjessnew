...
public class cek extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView = (WebView) findViewById(R.id.cek1);
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.cek);
        swipeRefreshLayout.setOnRefreshListener(cek.this);
    ...
    private void loadWebsite() {
        ...
        if (netInfo != null && netInfo.isConnectedOrConnecting()) {
            mWebView.loadUrl("https://daftar.bpjs-kesehatan.go.id/bpjs-checking/");
        } else {
