...
public class monitoring extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView = (WebView) findViewById(R.id.monitoring1);
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.monitoring);
        swipeRefreshLayout.setOnRefreshListener(monitoring.this);
    ...
    private void loadWebsite() {
        ...
        if (netInfo != null && netInfo.isConnectedOrConnecting()) {
            mWebView.loadUrl("http://hfis.bpjs-kesehatan.go.id/hfis/MonitoringPendaftaran/dataFaskesTerdaftar/");
        } else {
